...
const BillingSummaryReport = ({billerId, reportId, intl}) => {
    ...
    const handleDownload = () => {
        window.open(`/download/reports/download/${reportId}/billingReportSummary`);
    };
...
export default injectIntl(BillingSummaryReport);
